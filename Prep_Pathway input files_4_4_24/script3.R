...
#data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAAUCAYAAACnOeyiAAAAXklEQVR4XmNgAIL///8zMYSGhjIDGYIMIiIMvECGMwMDN4M4kFEDUqIIZKwDMdSBjAsghj6Q8QPEMAAy/lOBoQekv4AYKkDGfgZeXl4RICOLQUtLiw3IUAJJMQIZ7AC2tU2tJWCy/wAAAABJRU5ErkJggg== Function to convert empirical compound names to KEGG IDs using t.score
convert_to_kegg <- function(compounds, merged_data) {
  # Extract the empirical compounds from the string
  compounds_list <- unlist(strsplit(gsub("[c()']", "", compounds), ", "))
...
output_path <- "C:/Users/Remi/Documents/TAMUCC M.S chemi/Medaka Bone metabolic study/Metaboanalyst_inR/MetabAnalyst_inR/MetaboAnalystR_3_29_24/Table figure 2 and 3/finaltable_F8movsF3mo.xlsx"
